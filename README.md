...
[![Build Status](https://secure.travis-ci.com/javadev/underscore-java.svg)](https://travis-ci.com/javadev/underscore-java)
...
```groovy
compile 'com.github.javadev:underscore:1.63'
```
